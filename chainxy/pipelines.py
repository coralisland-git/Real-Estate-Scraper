...
class ChainxyPipeline(object):
    ...
    def process_item(self, item, spider):
        ...
        if count == 0:
            ...
            sql += "(folio, pin, owner, owner_addr, owner_city, owner_state, owner_zip, site_addr, site_city, site_state, site_zip, bed, bath, square_footage, zestimate, active, icomps, redfin, trulia, movoto, realtor) "

            sql += "VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s'); " %(item['Folio'], item['Pin'], item['Owner'], item['Owner_Addr'], item['Owner_City'], item['Owner_State'], item['Owner_Zip'], item['Site_Addr'], item['Site_City'], item['Site_State'], item['Site_Zip'], item['Bed'], item['Bath'], item['Square_Footage'], item['Zestimate'], item['Active'], item['Icomps'], item['Redfin'], item['Trulia'], item['Movoto'], item['Realtor'])
            ...
            sql += " zestimate='%s', active='%s', icomps='%s', redfin='%s', trulia='%s', movoto='%s', realtor='%s' WHERE folio='%s'"

            sql = sql %(item['Folio'], item['Pin'], item['Owner'], item['Owner_Addr'], item['Owner_City'], item['Owner_State'], item['Owner_Zip'], item['Site_Addr'], item['Site_City'], item['Site_State'], item['Site_Zip'], item['Bed'], item['Bath'], item['Square_Footage'], item['Zestimate'], item['Active'], item['Icomps'], item['Redfin'], item['Trulia'], item['Movoto'], item['Realtor'] , item['Folio'])
